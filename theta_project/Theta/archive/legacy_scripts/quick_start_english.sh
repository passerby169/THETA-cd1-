#!/bin/bash
# =============================================================================
# THETA Quick Start - English Dataset (True One-Click)
# =============================================================================
...
#
# Usage:
#   ./quick_start_english.sh <dataset_name>
#
# Example:
#   ./quick_start_english.sh my_research_docs
# =============================================================================
...
if [ -z "$CSV_FILE" ]; then
    ...
    PYTHONPATH="$ETM_DIR:$PYTHONPATH" python -m dataclean.main convert "$DATA_DIR/$DATASET" "$CSV_FILE" --language english --recursive
...
python -m visualization.run_visualization --result_dir "$RESULT_DIR" --dataset $DATASET --mode zero_shot --model_size 0.6B --language en --dpi 300 || {
...
echo "  - Visualization: $RESULT_DIR/0.6B/$DATASET/zero_shot/visualization/"
echo ""
echo "=========================================="
